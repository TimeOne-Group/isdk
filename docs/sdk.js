...
(function () {
  ...
  var getBuiltIn$1 = function getBuiltIn(namespace, method) {
    return arguments.length < 2 ? aFunction$2(global$2[namespace]) : global$2[namespace] && global$2[namespace][method];
  };
  ...
  var document$2 = global$2.document; // typeof document.createElement is 'object' in old IE
  ...
  */
  ...
  for (var COLLECTION_NAME$1 in domIterables$1) {
    handlePrototype(global$2[COLLECTION_NAME$1] && global$2[COLLECTION_NAME$1].prototype, COLLECTION_NAME$1);
  }
  ...
  */
  ...
  function objectToString() {
    ...
    return JSON.stringify(object, Object.getOwnPropertyNames(object), '\t').replace(/\n/g, '<br>').replace(/\t/g, '&nbsp;&nbsp;&nbsp;');
  }
  ...
  var showDebug = function showDebug(callback) {
    if (!document.getElementById('debug')) {
      ...
      var _window$sdkName2, _window$sdkName3, _window$sdkName4;
  ...
  var _canTrack = /*#__PURE__*/new WeakSet();

  var TogSdk = /*#__PURE__*/function () {
    function TogSdk() {
      _classCallCheck(this, TogSdk);

      _classPrivateMethodInitSpec(this, _canTrack);
    ...
    _createClass(TogSdk, [{
      key: "consent",
      get: function get() {
        var _helpers$getValue;

        return (_helpers$getValue = getValue(CONSTANTS.consent.name)) !== null && _helpers$getValue !== void 0 ? _helpers$getValue : CONSTANTS.consent.status.unknown;
      }
    }, {
      key: "subid",
      get: function get() {
      ...
      key: "setConversion",
      value: function setConversion() {
        if (_classPrivateMethodGet(this, _canTrack, _canTrack2).call(this)) {
      ...
      value: function push(args) {
        ...
        return this[functionName].apply(this, _toConsumableArray(functionArgs));
      }
    }, {
      key: "getTrace",
  ...
  function init() {
    var Sdk = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : TogSdk;
    ...
    try {
      ...
      } else if (_typeof(window[sdkName]) === 'object' && window[sdkName] instanceof Sdk) {// Nothing
      } else {
  ...
  var TogDebugSdk = /*#__PURE__*/function (_TogSdk) {
    _inherits(TogDebugSdk, _TogSdk);
